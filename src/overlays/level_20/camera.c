...
INCLUDE_ASM("asm/nonmatchings/overlays/level_20/camera", func_level_20_8008BF8C);

/**
 * ???() - func_level_20_8008C2AC() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_20_8008C2AC() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_20/camera", func_level_20_8008C310);

INCLUDE_ASM("asm/nonmatchings/overlays/level_20/camera", func_level_20_8008C438);
