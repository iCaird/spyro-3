...
INCLUDE_ASM("asm/nonmatchings/overlays/level_13/camera", func_level_13_8008BE24);

/**
 * ???() - func_level_13_8008C28C() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_13_8008C28C() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_13/camera", func_level_13_8008C2B4);

INCLUDE_ASM("asm/nonmatchings/overlays/level_13/camera", func_level_13_8008C3B4);
