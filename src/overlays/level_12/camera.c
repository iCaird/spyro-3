...
INCLUDE_ASM("asm/nonmatchings/overlays/level_12/camera", func_level_12_8008B480);

/**
 * ???() - func_level_12_8008B9AC() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_12_8008B9AC() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_12/camera", func_level_12_8008B9D4);

INCLUDE_ASM("asm/nonmatchings/overlays/level_12/camera", func_level_12_8008BAC4);
