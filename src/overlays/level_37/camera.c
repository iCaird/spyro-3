...
INCLUDE_ASM("asm/nonmatchings/overlays/level_37/camera", func_level_37_8008B554);

/**
 * ???() - func_level_37_8008B790() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_37_8008B790() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_37/camera", func_level_37_8008B7F4);

INCLUDE_ASM("asm/nonmatchings/overlays/level_37/camera", func_level_37_8008B91C);
