...
INCLUDE_ASM("asm/nonmatchings/overlays/level_35/camera", func_level_35_8008BD08);

/**
 * ???() - func_level_35_8008C21C() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_35_8008C21C() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_35/camera", func_level_35_8008C244);

INCLUDE_ASM("asm/nonmatchings/overlays/level_35/camera", func_level_35_8008C368);
