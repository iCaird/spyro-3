...
INCLUDE_ASM("asm/nonmatchings/overlays/level_26/camera", func_level_26_8008A828);

/**
 * ???() - func_level_26_8008ABAC() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_26_8008ABAC() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_26/camera", func_level_26_8008ABD4);

INCLUDE_ASM("asm/nonmatchings/overlays/level_26/camera", func_level_26_8008AC74);
