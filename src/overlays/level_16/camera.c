...
INCLUDE_ASM("asm/nonmatchings/overlays/level_16/camera", func_level_16_80086260);

/**
 * ???() - func_level_16_8008646C() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_16_8008646C() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_16/camera", func_level_16_80086494);

INCLUDE_ASM("asm/nonmatchings/overlays/level_16/camera", func_level_16_80086564);
