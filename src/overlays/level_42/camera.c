...
INCLUDE_ASM("asm/nonmatchings/overlays/level_42/camera", func_level_42_8008F4FC);

/**
 * ???() - func_level_42_8008FB68() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_42_8008FB68() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_42/camera", func_level_42_8008FB90);

INCLUDE_ASM("asm/nonmatchings/overlays/level_42/camera", func_level_42_8008FD1C);
