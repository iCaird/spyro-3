...
INCLUDE_ASM("asm/nonmatchings/overlays/level_47/camera", func_level_47_8008D8D0);

/**
 * ???() - func_level_47_8008DC38() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_47_8008DC38() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_47/camera", func_level_47_8008DC60);

INCLUDE_ASM("asm/nonmatchings/overlays/level_47/camera", func_level_47_8008DDF8);
