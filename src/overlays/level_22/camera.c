...
INCLUDE_ASM("asm/nonmatchings/overlays/level_22/camera", func_level_22_8009A254);

/**
 * ???() - func_level_22_8009AB80() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_22_8009AB80() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_22/camera", func_level_22_8009ABA8);

INCLUDE_ASM("asm/nonmatchings/overlays/level_22/camera", func_level_22_8009ACDC);
