...
INCLUDE_ASM("asm/nonmatchings/overlays/level_30/camera", func_level_30_8008CD14);

/**
 * ???() - func_level_30_8008D034() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_30_8008D034() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_30/camera", func_level_30_8008D098);

INCLUDE_ASM("asm/nonmatchings/overlays/level_30/camera", func_level_30_8008D1C0);
