...
INCLUDE_ASM("asm/nonmatchings/overlays/level_50/camera", func_level_50_8009F9D8);

/**
 * ???() - func_level_50_800A02BC() - MATCHING
 * https://decomp.me/scratch/wQiRZ
 */
void func_level_50_800A02BC() {
...
INCLUDE_ASM("asm/nonmatchings/overlays/level_50/camera", func_level_50_800A0320);

INCLUDE_ASM("asm/nonmatchings/overlays/level_50/camera", func_level_50_800A04C0);
